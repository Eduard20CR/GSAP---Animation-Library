...
export class AnimationsDataService implements OnInit {
    ...
    setAnimations() {
                ...
                switch (config.direction) {
                    ...
                    default:
                        return console.error(
                            "You hace to put a direction: '{direction:'left/right/top/bottom'}'"
                        );
                }
            },
        ...
        gsap.registerEffect({
            ...
            effect: (targets, config) => {
                switch (config.direction) {
                    ...
                    default:
                        return console.error(
                            "You hace to put a direction: '{direction:''}'"
                        );
                }
            },
            defaults: { duration: 1, ease: 'power1.inOut', opacity: 1 },
        ...
        gsap.registerEffect({
            ...
            defaults: { duration: 0.3, ease: 'power1.inOut', scale: 1.2, repeat: 1 },
            extendTimeline: true,
        });
        //BOUNCE ATENTION
        gsap.registerEffect({
            ...
            defaults: { duration: 0.5, ease: 'power1.inOut', y: -20 },
            extendTimeline: true,
        });
